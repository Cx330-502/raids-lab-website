...
title: 火山統合ガイド
description: 
  クレーターはどのようにしてボルカノバッチスケジューラを利用して、マルチラボのGPUリソース管理や分散型ワークロードに取り組んでいるのか。
---
...
[Volcano](https://volcano.sh/ja/) is a batch scheduling system designed for high-performance workloads such as AI/ML training, big data, and scientific computing. In Crater, Volcano is used to manage GPU scheduling across multiple labs and users in a fair and preemptive way.
...
Crater uses Volcano’s [Job CRD](https://volcano.sh/ja/docs/job-tutorial/) to support:
